...
export default function Info(){
    ...
    return(
            ...
            <div className='ftStrip_canvas_infoCon'>
                ...
                <br/>
                <br/>
                Here I will demonstrate how to use this simulator. Press the middle button in the right side. The graph shows the ideal space multiplies by the <i style={{margin:'0'}}> &quot;I&quot; </i>matrix. Press the button at the bottom to change the value of the matrix and look at its effect on the graph. You can switch the top button to toggle between dark and normal mode
                </div>
