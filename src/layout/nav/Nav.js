        ...
        <nav className='nav'>
            ...
            <div className='navGrid'>
                <div id='mainTitle' ref={title} className='navGrid_titleCon'>
                    <h1 className='navGrid_titleCon_title' aria-label="Main Title: Walaa's Web, AI's Zest, Robotics Nest, Progress Quest">With hardship comes ease; be patient and passionate</h1>
                </div>
